...
const Home = () => {
  ...
  useEffect(() => {
    const fetchKitchens = async () => {
      try {
        const response = await axios.get(`${import.meta.env.VITE_BACKEND_URL}/kitchens`);
  ...
  return (
    <div className="min-h-screen bg-neutral-100 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <h1 className="text-3xl font-bold text-gray-900 mb-8">Available Kitchens</h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {kitchens.map((kitchen) => (
            ...
            >
              ...
              <div className="p-4">
                <h2 className="text-xl font-semibold text-gray-900 mb-2">{kitchen.name}</h2>
